...
class MetricMeter:
    ...
    def report(self, print_stats=True, mean_only=False, ignore_first_class=False):
        """
        ...
        """
        class_names = self.class_names[1:] if ignore_first_class else self.class_names
        report_str = ''
        for metric in self.metrics:
    ...
    def save(self, savedir='./metrics', filename='metric.csv', ignore_first_class=False):
        """
    ...
    def to_df(self, ignore_first_class=False):
        """
    ...
    def pop_data(self, mean_only=False, ignore_first_class=False):
        """
    ...
    def pop_mean_metric(self, ignore_first_class=False):
        """
